  ...
  if (isEdit) {
    return (
      <Box
        ...
        width="25%"
      >
        <Text fontSize={26} color="facebook.500">
          Genre
        </Text>
        <Select mt={5} placeholder="Select Genre" onChange={onChangeGenre}>
          {allGenres.length > 0 &&
            allGenres.map((genre, index) => {
              return (
                <option key={genre._id} value={index}>
                  {genre.name}
                </option>
              );
            })}
        ...
        <Button colorScheme="facebook" onClick={onClickEdit}>
          Edit
        </Button>
        <Button
          color="facebook.500"
    ...
    return (
      ...
      >
        ...
        <Input
          ...
          placeholder="Genre Name"
          value={genreName}
          onInput={(e) => setGenreName(e.target.value)}
        />
        <Select
          mb={5}
          value={status}
