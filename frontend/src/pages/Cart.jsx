        ...
        >
          {userAddress && (
            ...
            >
              ...
              <Text mt={3} fontSize={24} color="facebook.500" fontWeight={300}>
                {userAddress}
              </Text>
            </Box>
          )}
          <Text fontSize={28} mt={10} fontWeight={600} color="facebook.500">
            Order Details
          </Text>
          <Text mt={3} fontSize={24} color="facebook.500" fontWeight={300}>
          ...
          <Button mt={10} colorScheme="facebook" onClick={onClickPurchase}>
            Purchase
          </Button>
          <Button
            mt={3}
    ...
    return (
      ...
      >
        ...
        <Text textAlign="center" fontSize={24} mt={3} fontWeight={300}>
          You haven't added a product to your cart. All you have to do is click
          on the cart icon.
        </Text>
        <Button
          variant="solid"
